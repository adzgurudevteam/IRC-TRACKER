...
function printContent()
{
  ...
  if (count($getCompData) > 0) {
          ...
          if (count($getAuditAssignData)>0) {
              foreach ($getAuditAssignData as $aadk => $aadv) {
                  if ($aadv[COMPANY_ASSIGNED_DATA::PRIMARY_SECONDARY==1]) {
                      ...
                      $otherAuditHtml.='
                      <tr>
                          <td colspan="4" class="text-center">Assisting Other Audits</td>
                      </tr>
                      <tr>
                          <td>'.$sl.'</td>
                          <td>'.$name.'</td>
      ...
      $fullHtml.='
          <tr>
              <td colspan="'.$colspan.'"><b>Total Time: </b></td>
              <td>'.($totOwnCase+$totOtherCase).'</td>
          </tr>
      </tbody>
      ';
      $otherAuditHtml.='
...
?>
  <h4 class="text-center main_heading">Time Spent Record</h4>
  <h6 class="text-center sub_heading">Record your time spent record here</h6>
    ...
    <div class="card-body">
              ...
              <div class="col-md-10">
                <h4 class="mb-0">
                  <button class="btn btn-link btn-block text-left collapsed collapseCtrlBtn" style="font-size: 14px !important;" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                    Click to Input Hrs of <b class="text-danger"><?=getFormattedDateTime(getToday(false),LONG_DATE_FORMAT);?></b>
                  </button>
                </h4>
              </div>
              <div class="col-md-2 text-right">
              <button class="btn btn-light text-left collapsed collapseCtrlBtn" style="font-size: 14px !important; border:none;" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                    ...
                    <fieldset class="fldset">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-12 text-right mt-2">
                            <button type="button" class="btn btn-sm btn-primary" id="saveAuditorOtherActBtn">Save</button>
                        </div>
                      </div>
                    </fieldset>
                  </div>
      ...
      <div class="row mt-3" id="AudDailyReportViewArea">
            <div class="col-md-12 text-right">
                <button type="button" class="btn btn-sm btn-info no-print" style="display: none;" onclick="printDiv('AudDailyReportViewArea')"><small><i class="fas fa-print"></i>&nbsp;Print</small></button>
            </div>
            <div class="col-md-12">
